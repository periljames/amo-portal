...
REFERENCE_POSITIONS = (
    ...
    ("STORES_SUPERVISOR", "STS", "Procurement & Stores Supervisor", "SUPERVISOR", "BASE_MAINTENANCE_MANAGER"),
    ...
    ("PROCUREMENT_OFFICER", "PO", "Procurement Officer", "STAFF", "STORES_SUPERVISOR"),
    ("TECHNICAL_STORES_PERSONNEL", "TSP", "Technical Stores Personnel", "STAFF", "STORES_SUPERVISOR"),
