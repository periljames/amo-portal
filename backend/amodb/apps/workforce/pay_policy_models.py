...
from sqlalchemy import CheckConstraint, Column, DateTime, ForeignKey, Index, Numeric, String, UniqueConstraint
...
class EmploymentContractPayPolicy(Base):
    ...
    __table_args__ = (
        ...
        Index("ix_contract_pay_policy_amo", "amo_id"),
        Index("ix_contract_pay_policy_contract", "contract_id"),
    ...
    contract_id = Column(String(36), ForeignKey("employment_contracts.id", ondelete="CASCADE"), nullable=False)
