...
ANALYSIS_ROLES = {
    "QUALITY_MANAGER", "QUALITY_OFFICER", "SAFETY_MANAGER", "SAFETY_OFFICER",
    "BASE_MAINTENANCE_MANAGER", "LINE_MAINTENANCE_MANAGER", "WORKSHOP_MANAGER",
...
QUALITY_REVIEW_ROLES = {"QUALITY_MANAGER"}
APPROVAL_ROLES = {"ACCOUNTABLE_EXECUTIVE"}
PROFILE_ADMIN_ROLES = {"QUALITY_MANAGER"}
