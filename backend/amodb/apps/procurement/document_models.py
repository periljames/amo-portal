...
from sqlalchemy import Boolean, Column, Date, DateTime, Enum as SAEnum, ForeignKey, Index, Integer, String, Text
...
class ProcurementDocument(Base):
    ...
    __table_args__ = (
        ...
        Index("ix_procurement_documents_amo_status", "amo_id", "status"),
