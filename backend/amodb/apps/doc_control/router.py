...
from .workspace_compatibility_guard import quarantine_legacy_copy_mutations, quarantine_legacy_core_mutations
...
quarantine_legacy_core_mutations(core_router)
