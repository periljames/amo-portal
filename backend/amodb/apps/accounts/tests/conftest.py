...
def db_session():
    ...
    Base.metadata.create_all(
        ...
        tables=[
            ...
            models.AuthCapabilityDefinition.__table__,
            models.AuthRoleDefinition.__table__,
            models.AuthRoleCapabilityBinding.__table__,
            models.AuthUserRoleAssignment.__table__,
