...
# Enforce credential inheritance, terminal fiscalization and frontend-link rules
# inside shared service/router functions before either superuser or tenant-admin
# routes capture them.
