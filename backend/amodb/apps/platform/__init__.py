...
# Enforce credential inheritance and terminal fiscalization rules inside shared
# service functions before either superuser or tenant-admin routes capture them.
