...
def _global_factors(
    ...
    mapping = (
        ...
        ("HIGH_CRITICAL_RISKS", "High / critical risks", (metrics["high_risks"] + metrics["critical_risks"] if metrics.get("high_risks") is not None and metrics.get("critical_risks") is not None else None), "risk", "quality_assurance_metrics.high_risks+critical_risks", "Open high or critical governed risks increase assurance attention."),
