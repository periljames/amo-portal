...
/**
 * Network range size and canvas retention solve different problems. Keep the
 * requested 20 MiB default and 50 MiB stable-network bursts, while bounding
 * canvas count and pixel density so a fast network does not trigger hundreds
 * of megabytes of simultaneous page surfaces.
 */
