...
export const canonicalModuleRoutes = {
  ...
  qmsRoot: "/maintenance/:amoCode/quality",
  qmsTrainingRoot: "/maintenance/:amoCode/training/competence/dashboard",
  qmsTrainingPerson: "/maintenance/:amoCode/training/competence/people/:userId",
...
export const buildCanonicalRoute = {
  ...
  qmsRoot: ({ amoCode }: AmoRouteParams) => `/maintenance/${encodeSegment(amoCode)}/quality`,
  qmsTrainingRoot: ({ amoCode }: AmoRouteParams) => `/maintenance/${encodeSegment(amoCode)}/training/competence/dashboard`,
  qmsTrainingPerson: ({ amoCode, userId }: UserRouteParams) => `/maintenance/${encodeSegment(amoCode)}/training/competence/people/${encodeSegment(userId)}`,
