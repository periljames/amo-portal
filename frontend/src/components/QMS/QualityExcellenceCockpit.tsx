    ...
    <main className="qew-page" aria-label="Quality continuous assurance control centre">
      <header className="qew-header">
        ...
        <div className="qew-header__actions">
          ...
          <button type="button" className="is-primary" onClick={() => navigate(`/maintenance/${encodeURIComponent(amoCode)}/quality/audits/plan?view=calendar&create=1`)}><Plus size={16} /> Schedule audit</button>
        </div>
      </header>
