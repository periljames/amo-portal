...
import ProcurementEnhancementDock from "../procurement/ProcurementEnhancementDock";
...
const PageHeader: React.FC<PageHeaderProps> = ({
  ...
  const isProcurement = /^\/maintenance\/[^/]+\/procurement(?:\/|$)/.test(location.pathname);
  ...
  return (
    <>
      ...
      {isProcurement ? <ProcurementEnhancementDock /> : null}
    </>
  );
};
