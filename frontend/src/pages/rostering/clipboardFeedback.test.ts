...
describe("global clipboard feedback", () => {
  ...
  it("resets repeated notifications and respects reduced motion", () => {
    expect(feedbackSource).toContain("clearToastTimers");
    expect(feedbackSource).toContain('classList.remove("is-visible", "is-leaving")');
