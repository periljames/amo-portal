          ...
          <section className="aum-three-col">
            ...
            <article className="aum-panel">
              ...
              <div className="aum-stack">
                ...
                {!user.is_superuser && isPlatformSuperuser ? <label className="aum-field"><span>Standing AMO Administrator</span><select className="aum-select" value={profileStandingAdmin ? "yes" : "no"} onChange={(event) => setProfileStandingAdmin(event.target.value === "yes")}><option value="no">Not assigned</option><option value="yes">Assigned</option></select><small>The platform superuser appoints standing administrators permanently. The superuser or this AMO’s Accountable Executive can revoke administrator access through Administrator governance. Personal certification still requires authorization.</small></label> : null}
