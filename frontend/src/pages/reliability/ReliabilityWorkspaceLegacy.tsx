...
const ReliabilityWorkspaceLegacy: React.FC = () => {
      ...
      <main className="reliability-v2">
        <header className="reliability-v2__header">
          ...
          <div className="reliability-v2__actions">
            ...
            <Link className="btn btn-secondary" to={`${basePath}/workbook-parity`}>Workbook registers</Link>
...
export default ReliabilityWorkspaceLegacy;
