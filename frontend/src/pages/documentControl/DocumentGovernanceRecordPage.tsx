        ...
        <div className="dgov-record" data-testid="document-governance-record">
          ...
          <section className="dgov-panel">
            ...
            {showAssignment && canControl ? <div className="dgov-assignment-form">
              ...
              {assignment.assignee_type === "ROLE" ? <label>Role<input value={assignment.role} onChange={(event) => setAssignment({ ...assignment, role: event.target.value })} placeholder="e.g. QUALITY_MANAGER" /></label> : null}
