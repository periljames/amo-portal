...
export default function DocumentControlReportsPage() {
  ...
  return <DocumentControlShell
    ...
    subtitle="Authoritative Document Control registers remain bounded, filterable, exportable and linked back to the operational evidence that created them."
    canControl
    actions={<>
      ...
      <button type="button" className="dc-button dc-button--primary" disabled={!hasRows} onClick={exportCurrentPage}><Download size={14} /> Export current page CSV</button>
    </>}
  >
    <section className="dms-reports" data-testid="document-control-reports" aria-busy={refreshing}>
