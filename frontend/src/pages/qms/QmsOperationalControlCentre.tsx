          ...
          {hasAttention ? (
            <>
              ...
              <div className="qms-assurance-room__primary-grid">
                ...
                {dashboard.upcoming_obligations.length ? <QmsUpcomingObligations amoCode={amoCode} items={dashboard.upcoming_obligations} fallbackRoute={routes.calendar} asOf={dashboard.as_of} /> : null}
              </div>
            </>
          ) : null}
