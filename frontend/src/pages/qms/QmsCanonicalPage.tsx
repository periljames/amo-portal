...
import QmsPlannerPage from "./planner/QmsPlannerPage";
 ...
 * canonical page; /quality/calendar/* is handled by the modern planner workspace.
 */
export default function QmsCanonicalPage(): React.ReactElement {
  ...
  return isPlannerRoute ? <QmsPlannerPage /> : <QmsCanonicalLegacyPage />;
}
