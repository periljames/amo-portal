...
function workspaceDefinition(amoCode: string, workspace: WorkspaceId): WorkspaceDefinition {
  ...
  const definitions: Record<WorkspaceId, WorkspaceDefinition> = {
    ...
    assurance: {
      ...
      lenses: [
        { title: "Audit operations", description: "Programme, plan, execute and close governed audits and targeted surveillance.", path: `${quality}/audits/dashboard`, icon: ClipboardCheck, eyebrow: "Audits & surveillance" },
