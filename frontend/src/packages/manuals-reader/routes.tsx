...
export function ManualsReaderRoutes() {
  return (
    <Routes>
      ...
      <Route path="/maintenance/:amoCode/publications/:manualId/:chapterId/:sectionId" element={<ManualReaderPage />} />
      <Route path="/maintenance/:amoCode/publications/:manualId/:chapterId/:sectionId/:subSectionId" element={<ManualReaderPage />} />
      <Route path="/maintenance/:amoCode/publications/:manualId/figure/:figureId" element={<ManualReaderPage />} />
